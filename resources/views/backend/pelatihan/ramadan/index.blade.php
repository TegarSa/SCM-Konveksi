                    ...
                    <div class="card-header align-items-center">
                        <div class="row">
                            <div class="col-xl-12 text-end">
                                <a href="{{ route('bootramadan.create') }}" class="btn btn-primary">Tambah</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($bootcamps as $bootcamp)
                                    <tr>
                                        ...
                                        <td><a class="m-2 btn btn-info"
                                                href="{{ route('bootramadan.edit', $bootcamp->id) }}">
                                                <i class=" fas fa-solid fa-pen"></i>
                                            </a>

                                            <form action="{{ route('bootramadan.destroy', $bootcamp->id) }}" method="POST">
                                                @csrf
                                                @method('POST')
