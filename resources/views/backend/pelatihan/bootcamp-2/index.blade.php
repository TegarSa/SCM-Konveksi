                    ...
                    <div class="card-header align-items-center">
                        <div class="row">
                            ...
                            <div class="col-xl-12 text-end">
                                ...
                                <a href="{{ route('bootcamp2.create') }}" class="btn btn-primary">Tambah</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($bootcamps as $bootcamp)
                                    <tr>
                                        ...
                                        <td><a class="m-2 btn btn-info" href="{{ route('bootcamp2.edit', $bootcamp->id) }}">
                                                <i class=" fas fa-solid fa-pen"></i>
                                            </a>

                                            <form action="{{ route('bootcamp2.destroy', $bootcamp->id) }}" method="POST">
                                                @csrf
                                                @method('POST')
