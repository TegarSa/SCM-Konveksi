                    ...
                    <div class="card-header align-items-center">
                        <div class="row">
                            ...
                            x <div class="col-xl-12 text-end">
                                <a href="{{ route('bootcamp3.index') }}" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>

                    </div>
                    <div class="card-body">
                        <form action="{{ route('bootcamp3.update', $bootcamp->id) }}" method="POST"
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @else
                                        <iframe class="mt-3 rounded img-fluid" width="200px" height="100px"
                                            src="{{ asset('assets/doc/materi/online/' . $bootcamp->materi) }}"
                                            alt=""></iframe>
                                    @endempty
                                    @error('materi')
                                        <div class="invalid-feedback" role="alert">
