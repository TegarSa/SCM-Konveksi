        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kak.pelatihan.update', $pelatihan->id) }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="judul"
                                        ...
                                        placeholder="Masukan judul" value="{{ old('title', $pelatihan->judul) }}">
                                    @error('judul')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="latar_belakang" id="latar_belakang" class="form-control @error('latar_belakang') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->latar_belakang }}</textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="tujuan" id="tujuan" class="form-control @error('tujuan') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->tujuan }}</textarea>
                                    @error('tujuan')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="sasaran" id="sasaran" class="form-control @error('sasaran') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->sasaran }}</textarea>
                                    @error('sasaran')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="metode" id="metode" class="form-control @error('metode') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->metode }}</textarea>
                                    @error('metode')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="ruang_lingkup" id="ruang_lingkup" class="form-control @error('ruang_lingkup') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->ruang_lingkup }}</textarea>
                                    @error('ruang_lingkup')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="hasil" id="hasil" class="form-control @error('hasil') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->hasil }}</textarea>
                                    @error('hasil')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="lokasi" id="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->lokasi }}</textarea>
                                    @error('lokasi')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="tim_pelaksana" id="tim_pelaksana" class="form-control @error('tim_pelaksana') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->tim_pelaksana }}</textarea>
                                    @error('tim_pelaksana')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="fasilitas" id="fasilitas" class="form-control @error('fasilitas') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->fasilitas }}</textarea>
                                    @error('fasilitas')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="waktu" id="waktu" class="form-control @error('waktu') is-invalid @enderror"
                                        placeholder="Keterangan">{{ $pelatihan->waktu }}</textarea>
                                    @error('waktu')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
