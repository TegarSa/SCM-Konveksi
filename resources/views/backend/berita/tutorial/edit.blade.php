                    ...
                    <div class="card-body">
                        <form action="{{ route('tutorial.update', $tutorial->id) }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" value="{{ $tutorial->title }}"
                            ...
                            <div class="mb-3 row">
                                <label class="col-form-label col-sm-2 text-sm-end">Url Youtube</label>
                                <div class="col-sm-10">
                                    <input type="text" name="url" value="{{ $tutorial->url }}"
                                        class="form-control @error('url') is-invalid @enderror"
                                        placeholder="Entry link url youtube">
                                    @error('url')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
