...
@section('content')
    <div class="p-0 container-fluid">
        ...
        <div class="mb-3">
            <h1 class="align-middle h3 d-inline">List Testimonial</h1>
        </div>
                    ...
                    <div class="card-header align-items-center">
                        <div class="row">
                            <div class="col-xl-12 text-end">
                                <a href="{{ route('testimonial.create') }}" class="btn btn-primary">Tambah</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($testimonials as $testimonial)
                                    <tr>
                                        ...
                                        <td><img class="rounded" width="80px" height="80px"
                                                src="{{ asset('backend/img/testimonial/' . $testimonial->image) }}"
                                                alt="">
                                        </td>
                                        <td>{{ $testimonial->name }}</td>
                                        <td>{{ $testimonial->instansi }}</td>
