...
@section('content')
    <div class="p-0 container-fluid">
        <div class="mb-3">
            <h1 class="align-middle h3 d-inline">Tambah Tag</h1>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('tags.store') }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Entry nama tag" value="{{ old('name') }}">
                                    @error('name')
