                    ...
                    <div class="card-body">
                        <form action="{{ route('training.update', $training->id) }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select  @error('narasumber_id') is-invalid @enderror"
                                        name="narasumber_id">
                                        <option value="{{ $training->narasumber->id }}" selected>
                                            {{ $training->narasumber->name }}</option>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" value="{{ $training->title }}"
                                        class="form-control @error('title') is-invalid @enderror" placeholder="Entry title">
                                    @error('title')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="start_register" value="{{ $training->start_register }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="end_register" value="{{ $training->end_register }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="start_training" value="{{ $training->start_training }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="image" value="{{ $training->image }}"
